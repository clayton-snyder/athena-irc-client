...
cl main.c msgqueue.c log.c terminalutils.c stringutils.c ws2_32.lib /Qspectre /DWIN32_LEAN_AND_MEAN /DTERMUTILS_DEBUG_ASSERT /Wall /wd4820 /wd5045 /WX /Fe: "$outfilename";
